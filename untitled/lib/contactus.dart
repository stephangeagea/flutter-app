...
class ContactUs extends StatelessWidget {
          ...
          children: <Widget>[
            ...
            Visibility(
              ...
              child: Card(
                ...
                color: cardColor,
                child: ListTile(
                  leading: Icon(Typicons.phone,color: Colors.white,),
                  title: Text(
            ...
            Card(
              ...
              color: cardColor,
              child: ListTile(
                leading: Icon(Typicons.mail,color: Colors.white,),
                title: Text(
                  emailText ?? 'Email ID',
                  style: TextStyle(
                    color: textColor,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorProperty('taglineColor', taglineColor));
  }
}
...
class ContactUsBottomAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextButton(
      ...
      child: Text(
        'Designed and Developed by SG \nWant to contact?',
        textAlign: TextAlign.center,
        style: TextStyle(
            color: textColor, fontSize: fontSize, fontFamily: textFont),
      ),
      onPressed: () => launch('mailto:'+'stgeagea@gmail.com'),
    );
  }
}